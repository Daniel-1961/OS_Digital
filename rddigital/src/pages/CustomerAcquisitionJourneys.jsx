...
const whatWeBuild = [
  {
    ...
    title: "Landing pages with clear goals",
    desc: "Every landing page is designed with a specific objective in mind, guiding visitors toward desired actions and maximizing conversions.",
  },
  {
    icon: "https://rd-cms.do.recognisedesign.com/uploads/layout_1_2_704ce29dc4.webp",
    title: "Fast-loading content across all devices",
    desc: "Optimized for speed, our landing pages load quickly on desktops, tablets, and mobile devices, ensuring a seamless user experience.",
  },
  {
    icon: "https://rd-cms.do.recognisedesign.com/uploads/layout_1_2_704ce29dc4.webp",
    title: "Forms that are easy to complete",
    desc: "Simplified and user-friendly forms reduce friction, making it quick and easy for visitors to provide their information.",
  },
  {
    icon: "https://rd-cms.do.recognisedesign.com/uploads/layout_1_2_704ce29dc4.webp",
    title: "CTA's That are visible And Tested",
    desc: "Strategically placed and tested calls-to-action grab attention and drive users to take meaningful steps, improving overall engagement and conversions.",
  },
];
...
export default function CustomerAcquisitionJourneys() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* ── HERO ── */}
      <section className="relative h-full pt-[7.5rem] lg:pt-[160px] lg:-mt-[120px] flex items-end lg:items-center justify-start overflow-hidden">
        <div className="block absolute inset-0 w-full h-full bg-[#F5F5F5] bg-[url(/images/hex-background-networking.jpg)] opacity-[45%] bg-cover pb-16 bg-center" />
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_1.175fr] px-4 lg:px-14 w-full xl:gap-12 2xl:gap-20 xl:container mx-auto pb-16 3xl:max-w-[50%] mt-[120px]">
          {/* Left col */}
          <div className="relative lg:top-0 text-left md:text-left text-[#042537]">
            ...
            <p className="text-sm text-center md:text-start md:text-lg md:mt-6 md:leading-[1.5] font-normal mt-4 !leading-[175%] tracking-normal capitalize">
              We help you turn website visitors into customers. It’s not just about traffic. It’s about action. We design flows that guide users from first click to conversion without confusion or delay.
            </p>
            {/* CTA row */}
            <div className="flex flex-row gap-6 items-center w-full lg:w-auto my-6">
              ...
              <div className="items-center sm:justify-center gap-2 text-black/90 hidden lg:flex">
                <GoogleRating />
              </div>
            </div>

            {/* Client logos strip */}
            <section className="relative flex overflow-x-auto rounded-[6.65px] lg:rounded-[10.4px] md:overflow-x-hidden bg-[#F5F5f5] border-[#E9E9E9] justify-around [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] w-full lg:w-fit mb-0">
          ...
          <div className="relative h-[30rem] mt-8 lg:mt-0 max-h-72 lg:max-h-full xl:h-full w-full flex items-center">
            <img
              loading="lazy"
              src="https://rd-cms.do.recognisedesign.com/uploads/Time_tracking_abfe6883d9.webp"
            ...
            />
            <div className="absolute top-0 left-0 right-0 w-full h-full z-20" />
          </div>
        </div>
      </section>
        ...
        <div className="bg-[#f5f5f5] rounded-[2rem] px-4 py-6 lg:pl-10 lg:pr-0">
          <div className="flex flex-col-reverse items-center lg:flex-row-reverse lg:justify-between gap-3 w-full">
            <img
              ...
              alt="Our Process"
              className="rounded-xl w-[120%] lg:w-[50%] xl:w-[60%] 2xl:w-[70%] object-cover process-image"
            />
