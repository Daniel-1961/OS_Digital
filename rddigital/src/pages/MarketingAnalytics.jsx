...
const whatWeBuild = [
  {
    ...
    title: "GA4 property with key events",
    desc: "Track critical user interactions and measure performance with a fully configured GA4 property that captures key events for actionable insights.",
  },
  {
    icon: "https://rd-cms.do.recognisedesign.com/uploads/layout_1_2_704ce29dc4.webp",
    title: "Tag Manager with custom tags",
    desc: "Easily manage and deploy marketing and analytics tags without touching code, including custom tags tailored to your specific tracking needs.",
  },
  {
    icon: "https://rd-cms.do.recognisedesign.com/uploads/layout_1_2_704ce29dc4.webp",
    title: "Conversion tracking for forms",
    desc: "Monitor form submissions and other conversions accurately to understand user behavior and optimize lead generation strategies.",
  },
  {
    icon: "https://rd-cms.do.recognisedesign.com/uploads/layout_1_2_704ce29dc4.webp",
    title: "Filters For Spam Bots & Bots",
    desc: "Keep your analytics data clean and reliable by filtering out traffic from spam bots and automated sources, ensuring you measure real user activity.",
  },
];
      ...
      <section className="relative h-full pt-[7.5rem] lg:pt-[160px] flex items-end lg:items-center justify-start overflow-hidden">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_1.175fr] px-4 lg:px-14 w-full xl:gap-12 2xl:gap-20 xl:container mx-auto pb-16 3xl:max-w-[50%]">
          ...
          <div className="relative h-[30rem] mt-8 lg:mt-0 max-h-72 lg:max-h-full xl:h-full w-full flex items-center">
            <img
              loading="lazy"
              src="https://rd-cms.do.recognisedesign.com/uploads/businesswoman_analyzing_data_touchscreen_8afb009ded.webp"
            ...
            <p className="absolute bottom-5 left-6 right-6 z-30 bg-black/20 w-fit rounded-xl py-3 px-4 text-white font-medium text-base lg:text-xl">
              Marketing Analytics Made Simple With GA4 + Tag Manager
            </p>
            <p className="absolute bottom-[-3.5rem] sm:bottom-[-2.5rem] xl:bottom-[-3.5rem] left-0 lg:left-6 right-0 lg:right-6 z-30 w-fit flex-wrap rounded-xl flex flex-row items-center justify-center gap-x-4 gap-y-0.5 lg:py-3 lg:px-4 text-white font-medium text-base lg:text-xl">
              {["Understand User Behavior Clearly", "Focus Only On What Matters", "Reliable Insights"].map((label, i) => (
